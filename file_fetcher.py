...
class Calculation(ArgTaker):
    ...
    def whole_year_cal(self):
        # List for holding whole year min, max data and date
        max_temperature_f = []
        max_temp_date_f = []
        ...
        while i < len(self.file_taker):
            with open(self.file_taker[i]) as infile:
                ...
                # Arrays for calculating max_temperature and respective date
                max_temperature = []
                max_temp_date = []

                # Arrays for calculating min_temperature and respective date
                min_temperature = []
                min_temp_date = []

                # Arrays for calculating max_humidity and respective date
                max_humidity = []
                max_humidity_date = []

                # Loop for fetching file data
                for row in input_file:
                    ...
                    # Check either date is present or not
                ...
                # appending List for holding whole year min, max data and date
...
class Stars:
    ...
    def star_fun(self):
        with open(self.file_taker[0]) as infile:
            ...
            input_file = csv.DictReader(infile, dialect='strip')
            # fieldnames = input_file.fieldnames
            # Arrays for calculating max_temperature
            max_temperature = []
            # Arrays for calculating min_temperature
            min_temperature = []
            # Loop for fetching file data
            i = 1
            for row in input_file:
...
# calling __init__ of ArgTaker class
arg_obj = ArgTaker()
...
while x < len(sys.argv):
    ...
    if sys.argv[x] == '-c':
        ...
        cal3.star_fun()
    # Bonus task, uncomment below code for execution
    #     if arg_obj.exp[1] == '-c':
